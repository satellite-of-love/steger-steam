		...
		switch (_p0.ctor) {
			...
			case 'Backwards':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						message: _elm_lang$core$String$reverse(model.say)
					});
			default:
				return _elm_lang$core$Native_Utils.update(
					model,
...
var _user$project$Main$model = {message: 'Hello Steger!', say: ''};
var _user$project$Main$Model = F2(
	function (a, b) {
		return {message: a, say: b};
	});
var _user$project$Main$Say = function (a) {
	return {ctor: 'Say', _0: a};
};
var _user$project$Main$sayInput = function (model) {
	return A2(
		_elm_lang$html$Html$input,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('say'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$Say),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$value(model.say),
					_1: {ctor: '[]'}
				}
			}
		},
...
var _user$project$Main$Backwards = {ctor: 'Backwards'};
var _user$project$Main$backwardsButton = A2(
	_elm_lang$html$Html$button,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$Backwards),
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('backwards'),
			_1: {ctor: '[]'}
		}
	},
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('Backwards'),
		_1: {ctor: '[]'}
	});
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Main$sayInput(model),
			_1: {
				ctor: '::',
				_0: _user$project$Main$backwardsButton,
				_1: {
					ctor: '::',
					_0: A2(
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"Backwards":[],"Say":["String"],"Noop":[]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
